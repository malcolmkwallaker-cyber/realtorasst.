...
export function buildTaskPrompt(inputs: Inputs, settings: Partial<UserSettings>): PromptSpec[] {
  ...
  const templateMap: Record<string, string> = {
    ...
    new_seller: `Create a task checklist for onboarding a new seller client at ${address}. Cover: signed listing agreement steps, photography scheduling, MLS input, social media launch, showing setup, and feedback collection system. Include ${agent} and ${vaName} assignments.`,
